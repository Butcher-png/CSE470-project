                        ...
                        <ul class="thumbnails">
                            ...
                            <div class="row-sm-3">
                                ...
                                <div class="caption">
                                  ...
                                  <h6><a class="btn btn-primary" title="Click for more details!" href="user_product_details.php?prod_id=<?php echo $res['prod_id'];?>">View</a><medium class="pull-right"><?php echo $res['prod_price']; ?></medium></h6>
                                </div>
